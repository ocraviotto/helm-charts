...
| postgresql | object | `{"Secondary":{},"auth":{"database":"ente_db","password":"changeme","username":"pguser"},"enabled":true,"image":{"repository":"bitnamilegacy/mariadb"},"primary":{}}` | Included PostgreSQL configuration NOTE: Because of https://github.com/bitnami/charts/issues/35164 there will be more changes to this section |
...
| postgresql.image | object | `{"repository":"bitnamilegacy/mariadb"}` | Values to pass to the postgresql sub-chart. See <https://github.com/bitnami/charts/tree/main/bitnami/postgresql> |
| postgresql.image.repository | string | `"bitnamilegacy/mariadb"` | Required because of https://github.com/bitnami/charts/issues/35164 |
